...
function buildPlaybookHtml({ name, grade, positionLabel, skillGap }) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8">' +
    ...
    '<div class="sub">South Florida / Built by Coach Blake Kingsley</div>' +
    ...
    '<div class="ft">Fast Basketball, South Florida. Forward this to another parent, a teammate, or a coach.</div>' +
    '</div></body></html>';
}
